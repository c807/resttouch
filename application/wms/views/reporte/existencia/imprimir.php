	...
	<table class="tabla-contenido">
		<tr>
			<td colspan="9" class="text-center">
				<h1>Reporte de Existencias <?php echo $subtitulo ?></h1>
			</td>
			...
			<?php foreach ($sedes as $sede) : ?>
				...
				?>
					<tr>
						...
						<td class="text-right">
							<?php
							echo number_format($row->saldo_inicial / $row->presentacion->cantidad, 5);
							// echo $row->saldo_inicial;
							?>
						</td>
						<td class="text-right">
						...
						<td class="text-right">
							<?php
							echo number_format($row->existencia / $row->presentacion->cantidad, 5);
							// echo $row->existencia;
							?>
						</td>
					</tr>
