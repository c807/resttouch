...
<body lang="es-GT" dir="ltr">
	<table class="table">
		<thead>
			...
			<tr>
				<th colspan="8" class="encabezado text-left sborder"><small>Bodega: <?php echo $lista[0]->bodega; ?></small></th>
			</tr>
			<tr>
				<th colspan="8" class="encabezado text-left sborder"><small>Sede: <?php echo $lista[0]->sede; ?></small></th>
			</tr>
			<tr>
				<td colspan="8"><br></td>
			</tr>
		...
		<tbody>
			<?php $total = 0; foreach ($lista as $key => $row): ?>
					<tr>
