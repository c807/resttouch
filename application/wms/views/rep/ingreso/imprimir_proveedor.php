...
<body>
	...
	<table class="tabla-contenido">
		...
		<?php $total = 0; $cantidad = 0; 
			...
			<?php foreach ($documento as $llave => $producto): 
				...
				<?php 
					...
					endforeach ?>
				<tr>
					<td class="totales text-right" colspan="4"><b>Total documento: </b></td>
			...
			<?php endforeach ?>
			<tr>
				<td class="totales text-right" colspan="4"><b>Total Proveedor: </b></td>
		...
		<?php endforeach ?>
		<tr>
			<td class="totales text-right" colspan="4"><b>Total</b></td>
