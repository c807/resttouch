        ...
        <table class="table table-bordered" style="padding: 5px">
            <thead>
                <?php if (!empty($reservas)): ?>
                    <tr>
                        <th colspan="4" style="padding: 5px;" class="text-center"><?php echo $reservas[0]->sede; ?></th>
                    </tr>
                <?php endif; ?>
                <tr>
            ...
            <tbody>
                ...
                <?php foreach ($reservas as $reserva): ?>
                    <tr>
                        <td style="padding: 5px;" class="text-left"><?php echo $reserva->articulo_descripcion; ?></td>
                        ...
                        <td style="padding: 5px;" class="text-right"><?php echo number_format($reserva->total, 2); ?></td>
                    </tr>
                    <?php $totalGeneral += $reserva->total; ?>
                <?php endforeach; ?>
            </tbody>
            <tfoot>
                <tr>
