...
INSERT INTO RT_DATABASE_NAME.medida (medida, descripcion) VALUES(2, TRIM('galón'));
INSERT INTO RT_DATABASE_NAME.medida (medida, descripcion) VALUES(3, TRIM('gramo'));
INSERT INTO RT_DATABASE_NAME.medida (medida, descripcion) VALUES(4, TRIM('kilogramo'));
INSERT INTO RT_DATABASE_NAME.medida (medida, descripcion) VALUES(5, TRIM('libra'));
INSERT INTO RT_DATABASE_NAME.medida (medida, descripcion) VALUES(6, TRIM('litro'));
INSERT INTO RT_DATABASE_NAME.medida (medida, descripcion) VALUES(7, TRIM('miligramo'));
INSERT INTO RT_DATABASE_NAME.medida (medida, descripcion) VALUES(8, TRIM('mililitro'));
INSERT INTO RT_DATABASE_NAME.medida (medida, descripcion) VALUES(9, TRIM('onza'));
INSERT INTO RT_DATABASE_NAME.medida (medida, descripcion) VALUES(10, TRIM('onza líquida'));
INSERT INTO RT_DATABASE_NAME.medida (medida, descripcion) VALUES(11, TRIM('pinta americana'));
INSERT INTO RT_DATABASE_NAME.presentacion(presentacion, medida, descripcion, cantidad) VALUES(1, 1, 'Unidad', 1);
INSERT INTO RT_DATABASE_NAME.presentacion(presentacion, medida, descripcion, cantidad) VALUES(2, 2, TRIM('galón'), 1);
INSERT INTO RT_DATABASE_NAME.presentacion(presentacion, medida, descripcion, cantidad) VALUES(3, 3, TRIM('gramo'), 1);
INSERT INTO RT_DATABASE_NAME.presentacion(presentacion, medida, descripcion, cantidad) VALUES(4, 4, TRIM('kilogramo'), 1);
INSERT INTO RT_DATABASE_NAME.presentacion(presentacion, medida, descripcion, cantidad) VALUES(5, 5, TRIM('libra'), 1);
INSERT INTO RT_DATABASE_NAME.presentacion(presentacion, medida, descripcion, cantidad) VALUES(6, 6, TRIM('litro'), 1);
INSERT INTO RT_DATABASE_NAME.presentacion(presentacion, medida, descripcion, cantidad) VALUES(7, 7, TRIM('miligramo'), 1);
INSERT INTO RT_DATABASE_NAME.presentacion(presentacion, medida, descripcion, cantidad) VALUES(8, 8, TRIM('mililitro'), 1);
INSERT INTO RT_DATABASE_NAME.presentacion(presentacion, medida, descripcion, cantidad) VALUES(9, 9, TRIM('onza'), 1);
INSERT INTO RT_DATABASE_NAME.presentacion(presentacion, medida, descripcion, cantidad) VALUES(10, 10, TRIM('onza líquida'), 1);
INSERT INTO RT_DATABASE_NAME.presentacion(presentacion, medida, descripcion, cantidad) VALUES(11, 11, TRIM('pinta americana'), 1);
...
ALTER TABLE RT_DATABASE_NAME.tarifa_reserva ADD COLUMN debaja TINYINT(1) NOT NULL DEFAULT 0, ADD COLUMN fechabaja DATETIME NULL, ADD COLUMN usuariobaja INT(11) NULL;
ALTER TABLE RT_DATABASE_NAME.detalle_comanda ADD COLUMN tiempo_pendiente TIME NULL;
